...
class PermissionService:
    """Enterprise service layer for Permission with business logic and validation."""
    ...
    def get_by_id(record_id):
        record = Permission.find_by_id(record_id)
        if not record:
            raise ValueError(f"Permission with id {record_id} not found")
        return record
