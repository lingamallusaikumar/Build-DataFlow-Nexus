...
class OrganizationService:
    """Enterprise service layer for Organization with business logic and validation."""
    ...
    def get_by_id(record_id):
        record = Organization.find_by_id(record_id)
        if not record:
            raise ValueError(f"Organization with id {record_id} not found")
        return record
